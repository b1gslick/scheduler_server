...
def test_user_can_add_activity_update_then_delete_it_should_return_empty_list_for_all_activity(
    test_client: Client,
) -> None:
    ...
    assert activity.id is not None, (
        f"last activity doesn't have id actual returned: {activity}"
    )
